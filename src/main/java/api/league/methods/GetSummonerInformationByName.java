...
public class GetSummonerInformationByName extends LeagueApiManager {

    public GetSummonerInformationByName(String summonerName) {

        this.setUrlBase("https://na1.api.riotgames.com/lol/summoner/v3/summoners/by-name/" + summonerName);
