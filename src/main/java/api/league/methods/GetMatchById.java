...
public class GetMatchById extends LeagueApiManager {

    public GetMatchById(String matchId) {

        this.setUrlBase("https://na1.api.riotgames.com/lol/match/v3/matches/" + matchId);
        ...
        this.setReturnType(MatchDto.class);
